...
const UserBalance: React.FC<UserBalanceProps> = ({
  ...
  return (
    <div className={`flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 ${className}`}>
      {showBackLink && (
        <Link
          to="/"
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        <div className={`${getBalanceColor()} border rounded-lg px-3 sm:px-4 py-2`}>
          <div className="flex items-center gap-2">
            <span className={`text-sm font-medium ${getBalanceTextColor()}`}>
              Saldo:
            </span>
