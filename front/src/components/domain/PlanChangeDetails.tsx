  ...
  return (
    <div className="mb-4 p-3 bg-yellow-50 rounded">
      ...
      <div className="space-y-1 text-sm">
        <p>
          Créditos em saldo:{' '}
          <span className="font-bold">{formatCurrency(creditInfo.databaseCredits)}</span>
        </p>
        ...
        <p>
          ...
          <span className="font-bold">
            ...
            [de {formatCurrency(creditInfo.proratedOld || creditInfo.proratedDiscount)}] *
          </span>
        </p>
        ...
        {showToCredit &&
          ...
          creditInfo.proratedOld > (creditInfo.proratedNew || 0) && (
            <span>
              À creditar: {formatCurrency(creditInfo.proratedOld - (creditInfo.proratedNew || 0))}
            </span>
          )}
      </div>
    </div>
